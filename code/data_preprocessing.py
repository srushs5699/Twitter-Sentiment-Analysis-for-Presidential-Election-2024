...
# # Load the dataset
# file_path = './dataset/dataset1_uncleaned_tweets_data_with_dates.csv'
...
# df.to_csv('dataset1_preprocessed_tweets_with_dates.csv', index=False)
...
# # Load the dataset
# file_path = './dataset/dataset2_uncleaned_tweets_data_with_dates.csv'
# df = pd.read_csv(file_path)
...
# # Save the preprocessed data to a new CSV file
# df.to_csv('dataset2_preprocessed_tweets_with_dates.csv', index=False)
